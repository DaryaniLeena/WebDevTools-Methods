...
const ViewWatchlistDetails = (props) => {
    const {
        username,
        patientName,
        hospitalName,
    ...
    const cancelBooking = function (docId) {
        ...
        fetchBookings(username).then((data) => {
            if (data) {
        ...
        <div className="hospital-list">
            <div className="row">
                <div className="left-list">
                    ...
                    <div className="booking-hospital">
...
export default ViewWatchlistDetails;
